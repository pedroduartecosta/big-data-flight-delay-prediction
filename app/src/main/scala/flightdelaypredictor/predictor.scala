...
object Flight {
  ...
  def main(args: Array[String]) {
    ...
    // sqrt(MSE):  9.796740796107883
    // mean absolute error: 6.887088798296243
    // R Squared: 0.9350795166082608
    // Explained Variance: 1382.225087766879

    // Linaer Regression - All but forbidden features and feaures which are highly correleted
    // sqrt(MSE):  9.85055218341565
    // mean absolute error: 6.891695864162034
    // R Squared: 0.934662584301822
    // Explained Variance: 1386.6828761967377
    ...
    // sqrt(MSE): 9.858289809687346
    // mean absolute error: 6.930385044621098
    // R Squared: 0.9343839060145654
    // Explained Variance: 1383.7301688723805
